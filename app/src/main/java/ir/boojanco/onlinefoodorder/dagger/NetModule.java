...
public class NetModule {
    ...
    @Provides
    @Singleton
    TransactionsViewModelFactory provideTransactionsViewModelFactory(Application application, UserRepository userRepository) {
        TransactionsViewModelFactory factory =
                new TransactionsViewModelFactory(application, userRepository);
        return factory;
    }
    ...
    ForgotPassViewModelFactory provideForgotPassViewModelFactory(Application application, UserRepository userRepository) {
        ForgotPassViewModelFactory factory =
                new ForgotPassViewModelFactory(application, userRepository);
        return factory;
    }
